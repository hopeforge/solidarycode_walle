package com.indracompany.walle.infrastructure.documentation.swagger;
...
import com.indracompany.walle.application.configuration.ApiInfoProperties;
...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.indracompany.walle.application"))
